...
export interface GameUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface GameUSD extends BaseContract {
  connect(runner?: ContractRunner | null): GameUSD;
  waitForDeployment(): Promise<this>;

  interface: GameUSDInterface;
