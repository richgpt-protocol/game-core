...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        name: "feeAndRewardContractAddress",
        type: "address",
        internalType: "address",
      },
      {
  ...
  {
    type: "error",
    name: "JACKPOT_CLAIMED",
    inputs: [],
  },
  {
    type: "error",
    name: "JACKPOT_HASH_NOT_CLAIMABLE",
    inputs: [],
  },
  {
    type: "error",
    name: "JACKPOT_HASH_NOT_FOUND",
    inputs: [],
  },
  {
    type: "error",
    name: "MAX_DRAW_REACHED",
    inputs: [],
  },
  {
    type: "error",
